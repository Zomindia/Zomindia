...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            profileImage = (ImageView) scrollViewLeftMenu.findViewById(R.id.imageViewProfile);
    ...
    public void updateProfile(String profile, String name, String mobile) {
       /* Glide.with(getContext()).load(profile).asBitmap().centerCrop().into(new BitmapImageViewTarget(profileImage) {
            @Override
...
//                .crossFade()
//                .thumbnail(0.5f)
//                .placeholder(R.drawable.login_logo1).dontAnimate()
//                .diskCacheStrategy(DiskCacheStrategy.ALL)
//                .into(profileImage);
