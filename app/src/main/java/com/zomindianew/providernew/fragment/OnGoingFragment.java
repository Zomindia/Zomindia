...
import com.zomindianew.providernew.adapter.OnGoingAdapter;
...
public class OnGoingFragment extends Fragment {
    ...
    public void init(View view) {
        ...
        adapter = new OnGoingAdapter(getActivity(), appointmentBeanArrayList);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);
        adapter.onItemClickMethod(new OnGoingAdapter.ItemInterFace() {
            @Override
            public void onItemClick(View view, int position) {
                switch (view.getId()) {
                    case R.id.onGoingRelative:
                        Intent intent = new Intent(getActivity(), BookingDetailActivity.class);
                        intent.putExtra("come_from", "on_going");
    ...
    public void getAppointment() {
        ...
        call = api.getAppointment(MySharedPreferances.getInstance(getActivity()).getString(Constants.ACCESS_TOKEN), "on_going");
