...
import com.zomindianew.providernew.adapter.UpcomingAdapter;
...
public class UpComingFragment extends Fragment {
    ...
    public void init(View view) {
        ...
        adapter = new UpcomingAdapter(getActivity(), appointmentBeanArrayList);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);
        adapter.onItemClickMethod(new UpcomingAdapter.ItemInterFace() {
            @Override
            public void onItemClick(View view, int position) {
                switch (view.getId()) {
                    case R.id.llBookingUser:
                        Intent intent = new Intent(getActivity(), BookingDetailActivity.class);
                        intent.putExtra("come_from", appointmentBeanArrayList.get(position).getStatus());
    ...
    public void getAppointment() {
        ...
        call = api.getAppointment(MySharedPreferances.getInstance(getActivity()).getString(Constants.ACCESS_TOKEN), "all");//upcomming
